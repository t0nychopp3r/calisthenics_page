<template>
    <div class="container-streetparks">
        <h2>Street Workout Parks</h2>
        <p class="normal-text">
        This site is a collection of street workout parks in Switzerland. You can find a park near you and start your workout journey. <br>
